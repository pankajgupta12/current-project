<?php
	...
	//$msg = "HR PIPE MAIL IS ADDING mail reading for hr@bcic.com.au";

	// use wordwrap() if lines are longer than 70 characters
   //	$msg = wordwrap($msg,70);
    
    // send email  
   // mail("ashishg.business2sell@gmail.com","Pipe is running for Bcic Email for Hr@beta.bcic.com.au, will set it by tomorrow.",$msg);
    ...
    //***************************************************************
            //#### REQUIRED UNFLAGGED EMAILS THROUGH
    //***************************************************************
    //$getemailData = $emailReader->inbox('UNFLAGGED',$mail_type);
   ...
   // $msg = "HR PIPE MAIL IS ADDED READING EMAILS DONE FOR TEAM.BETA";

	// use wordwrap() if lines are longer than 70 characters
	$msg = wordwrap($msg,70);

    // send email
	//mail("ashishg.business2sell@gmail.com","HR PIPE MAIL IS ADDED COMPLETE READING FOR TEAM.BETA@BCIC.COM.AU",$msg);
