...
$(document).on('click','.loadmore',function () 
{
  $(this).text('Loading...');
	$.ajax({
		url: 'xjax/ajax/loadmore_dispatch_report.php',
		type: 'POST',
		datatype: 'html',
...
<?
 ...
 /*   print_r($_SESSION['daily_dispatch']);
   echo '<br/>'; */
...
error_reporting(E_ALL); */
	...
	if($_SESSION['daily_dispatch']['called_type'] == "") {
      $_SESSION['daily_dispatch']['called_type'] = 1;
    } 

	/* if($_SESSION['daily_dispatch']['status'] == "") { $_SESSION['daily_dispatch']['status'] = 1;} 
	if($_SESSION['daily_dispatch']['status'] == 0) { unset($_SESSION['daily_dispatch']['status'])}	 */
...
$condi = $arg .' group by job_details.job_id ';
...
<div class="right_text_box" >
				    <?php  
				    $Countquery = mysql_query($condi);
                    $countRe = mysql_num_rows($Countquery);
				    ?>
    <div class="midle_staff_box"> <span class="midle_text">Total Records Found <?php echo $countRe; ?> </span></div>
</div>
<div class="usertable-overflow">
	<table class="user-table">
	  ...
	  <tr>
        ...
        <th>Name</th>
		<!--<th>Team Name</th>-->
		<?php  if($_SESSION['daily_dispatch']['called_type'] == 1) { ?>
         <th>Booking date</th>
		<?php  }elseif($_SESSION['daily_dispatch']['called_type'] == 2) { ?>
		 <th>Job Date</th>
		<?php  } ?>
        <th>Total Amt</th> 
		<th>Payment</th>
        ...
        <th>Staff</th>
		<th>CD to Client</th>
        <th colspan="2"> <?=$cont_var2;?></th>
        <th colspan="2">Email <?=$cont_var2;?></th>
        <th colspan="9">Staff Paid job Work </th>
		<th>Status</th>
		<th>T&C Acc</th>
		<th>Review Email</th>
		<!--<th>Email<br/>Agent</th>-->
	  </tr>	  
	  <tr>
		<th></th>
		<th></th>
        ...
        <th></th>
        <th>SMS</th>
        <th>Job <?php echo $cont_var;?></th>        <th>Add <?php echo $cont_var;?></th>
        <th>Booking <br> Conf</th>
        <th>Staff <br> Details</th>
		 <th>Job Status</th><th>Exp Time</th> <th>Start</th> <th>End</th> <th>Before Img</th>\<th>After Img</th><th>CheckList Img</th><th>Gurantee</th> <th>All <?php echo $cont_var;?></th>
        <th></th>
		<th></th>
        <th></th>
        <!--<th></th>-->
		...
		<tbody id="get_loadmoredata">
			...
			<tr class="load_more">
	         <td colspan="20"><button class="loadmore" data-page="2" >Load More</button></td>
			</tr>
			<?php } }else { ?>
          <tr>
