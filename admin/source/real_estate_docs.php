	   ...
	   <img src="xjax/image/loading1.gif" id="loaderimage" style="height:100px"/>
		<h2>Your Image File</h2>
			<div id="uploadImagedata1">
			 <?php  $imageupload = mysql_query("select * from real_estate_docs_file where real_estate_agent_id = ".$_REQUEST['id']);
			  ...
			  $i=1;
				 ...
				 if($getexte == 'pdf'){
					  ...
					  $class = '';
					   ...
					   $class = '';
						...
						$img = './img/real_estate_file/'.$_REQUEST['id'].'/'.$imagedata['image'];
						$class = 'group1';
					}	
				...
				?>
				  ...
				  <li id="imagefile_<?php echo $i; ?>"><a href="<?php echo  './img/real_estate_file/'.$_REQUEST['id'].'/'.$imagedata['image']; ?>" class="<?php echo $class;  ?>"><img src="<?php echo  $img;  ?>" width="50px" alt=""></a><span class="imagedelete" Onclick=" return imageDelete('<?php echo $i; ?>','<?php echo $imagedata['id']; ?>','<?php echo $imagedata['image'] ?>')"><img src='source/popup/delete.png' style="height:22px;"></span></li>
	...
	<style>
	   ...
	   .imagedelete{
		...
		$(function() {
			...
			var  page = 'real_estate';
			//getuploadimage(jobid);
			$("#uploader").plupload({
				// General settings
				
				runtimes : 'html5,flash,silverlight,html4',
				url : 'source/real_estate_file_upload.php?re_id='+id+'&page='+page,
				...
				filters : {
					...
					mime_types: [
						{title : "Image files", extensions : "jpg,gif,png,pdf,docx,doc"},
