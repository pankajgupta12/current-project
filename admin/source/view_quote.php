 ...
 <div class="view_quote_back_box">
	<div class="topbBarItems">
     <ul class="bb_4tabs heading_view_quote">
          <li><a href="/admin/index.php?task=view_quote">All</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=1">No Info</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=2">Info</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=4">A-Approved</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=9">C-Approved</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=3">Booked</a></li>
          <li><a href="/admin/index.php?task=view_quote&action=5">C-Denied</a></li> 
		  <li><a href="/admin/index.php?task=view_quote&action=6">A-Denied</a></li> 
		  <!--<li><a href="/admin/index.php?task=view_quote&action=11">Invt Wating</a></li> 
		  <li><a href="/admin/index.php?task=view_quote&action=10">Invt Approved</a></li>-->
		  <li><a href="/admin/index.php?task=view_quote&action=7">My Quote</a></li> 
		  <li><a href="/admin/index.php?task=view_quote&action=8">Delete Quote</a></li> 
    </ul>
	<div class="rightSideBox" >
		<ul class="view_quote">  
			...
			<li id="search_box_div">
				...
				<input name="booking_date" type="text" class="date_class  search_field" id="booking_date" placeholder="Booking date" style="display:none;" onchange="get_booking_date(this.value,'booking_date');a_reset(1);"/>  
				
				<input name="quote_date" type="text" class="date_class  search_field" id="quote_date" placeholder="Quote Date" style="display:none;" onchange="get_booking_date(this.value,'quote_date');a_reset(1);"/>  
				
				<input type="button" name="" value="" class="search_box" onClick="javascript:search_view_quote();a_reset(1);">	
			</li>   
	...
	<!--<span class="adSearch" Onclick="show_filter();"><a href="#" class="advance_search">Advance Search</a></span>-->
			...
			<div id="search_filter">		  
					<ul class="menuListingArea dispatch_top_ul dispatch_top_ul_viewquote dispatch5" style="background: rgba(17, 19, 19, 0.1);">
					    ...
					    <li>
						    ...
						    <input class="search_field"  type="hidden"  id="page_type" value="1">
						...
						<!--<li><strong>Booking date</strong>
							<input class="date_class" type="text"  placeholder="Booking date" name="booking_date" id="from_date" value="<?php if($_SESSION['view_quote_aSearching']['booking_date'] != '') {echo $_SESSION['view_quote_aSearching']['booking_date'];} ?>" >
						</li>
						
						<li><strong>Quote date</strong>
							<input class="date_class" type="text"  placeholder="Quote date" name="date" id="date" value="<?php if($_SESSION['view_quote_aSearching']['date'] != '') {echo $_SESSION['view_quote_aSearching']['date'];} ?>" >
						</li>-->
						...
						<li>
							<input type="button" name="reset" value="Reset"  onClick="a_reset(1);" class="offsetZero btnSet a_search_box" >	
						</li>
					</ul>
			</div>	
			...
			<ul class="dispatch_top_ul my-select">
			   <li><span><?php echo create_dd("job_type","system_dd","id","name","type=68","Onchange=\"view_quote_job_type(this.value);\"",$_SESSION['view_quote_aSearching_job_type']);?> </span></li>   
			   
			</ul>
				
			 <input type="button" value="Re-Check OTO" onclick="send_data('',280,'quote_view');" style="border: 1px solid;float:  right;margin-top:  13px;padding: 10px;background: #d9534f;cursor:  pointer;border-radius: 5px;color: #fff;">
