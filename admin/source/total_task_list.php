...
<div class="nav_form_main">
    <ul class="dispatch_top_ul dispatch_top_ul2 dispatch5">
		 ...
		 <li>
            ...
            <input class="date_class" type="text" name="from_date" id="from_date" value="<?php echo $_SESSION['total_track']['from_date']?>" >
        </li>
        <li>
            
            <label>To Date</label>
            <input class="date_class" type="text" name="to_date" id="to_date" value="<?php echo $_SESSION['total_track']['to_date']?>">
        </li> 
...
<br/><br/>
<div id="daily_view">
  <? include("xjax/view_total_task_list.php"); ?>
</div>
