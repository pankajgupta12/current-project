...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="<? echo $table_bgcolor;?>">
  <tr>
    <td colspan="2" class="boldtext"><font color="<? echo $table_fontcolor;?>">Refine Your Search</font></td>
    </tr>
    <tr>
    ...
    <td class="boldtext" bgcolor="<? echo $td_bgcolor;?>"><font color="<? echo $td_fontcolor;?>">Search Keyword</font></td>
     ...
     <? 
	   ...
	   foreach ($listheading as $valuex) { 
		...
		echo '<tr>
				<td class="boldtext" bgcolor="'.$td_bgcolor.'"><font color="'.$td_fontcolor.'">'.$valuex.'</font></td>
				<td class="boldtext" bgcolor="'.$td_bgcolor.'"><font color="'.$td_fontcolor.'"><input type="text" name="'.$valuex.'" id="'.$valuex.'" value="'.$_SESSION['search'][$valuex].'"></font></td>
			  </tr>';
			$xi = $xi +1;
		}?>
  
  <tr>
    <td colspan="2" bgcolor="<? echo $td_bgcolor;?>"><input type="submit" name="submit" id="submit" value="Search">
