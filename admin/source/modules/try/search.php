...
<form name="search_form" method="post" action="<? echo $_SERVER['SCRIPT_NAME']?>"><br />

<table width="90%" border="0" align="center" cellpadding="5" cellspacing="5" bgcolor="<? echo $table_bgcolor;?>" class="table_bg">
  <tr>
    <td colspan="2" class="header_td"><font color="<? echo $table_fontcolor;?>">Refine Your Search</font></td>
    <td align="right" class="text11_red">
    <? $xadd = get_rs_value("modules","xadd",$t); 
	if($xadd=="1"){ 
	    echo '<a href="/management/index.php?task='.$t.'&action=add">+ Add '.$title.'</a>';
	}
	if($t=="89"){ 
		 echo '&nbsp;<div id="somediv"></div><a href="javascript:send_data(\'\',55,\'somediv\');" id="somediv">[Add New Social Media]</a>';
	}
	?>
    </td>
    </tr>
