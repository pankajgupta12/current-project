...
<div class="nav_form_main">
    <ul class="dispatch_top_ul dispatch_top_ul2 dispatch5">
        ...
        <li>
         ...
         <li>
			<input type="button" style="margin-top:26px !important;cursor:  pointer;" name="" value="Search" class="offsetZero btnSent a_search_box" onclick="javascript:search_sales_report(2);">	
		</li>    		 
        <li>
			<label>&nbsp;</label>
			<input type="reset"  id="reset" onclick="javascript:reset_sales_report('<?php echo $dateString; ?>' , 2);" name="reset" value="Reset" />
		</li>			
...
<br/><br/>
<div id="daily_view">
  <? include("xjax/view_booked_sales_reports.php"); ?>
</div>
<script>
        $(function() {
