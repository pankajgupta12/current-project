...
$.widget("ui.plupload", {
	...
	*/
	...
	_handleFileStatus: function(file) {
		...
		switch (file.status) {
			case plupload.DONE:				
				actionClass = 'plupload_done pl_upload_test';
				iconClass = 'plupload_action_icon ui-icon ui-icon-circle-check pl_upload_now';				
				break;
		...
		$( "label.plupload_button" ).click();	
			/* $('label.plupload_button').click(function() {
			   location.reload();
			}); */
