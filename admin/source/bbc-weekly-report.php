<?
  /*  if(!isset($_SESSION['bbcweekly']['from_date'])){ $_SESSION['bbcweekly']['from_date'] = date('Y-m-d' ,  strtotime('last Wednesday'));  }
    if(!isset($_SESSION['bbcweekly']['to_date'])){ $_SESSION['bbcweekly']['to_date'] = date('Y-m-d'); }
    
   echo  $fromdate = date('Y-m-d' ,  strtotime('last Wednesday'));
...
<div id="daily_view">
  <? include("xjax/view_bbc-weekly-report.php"); ?>
</div>
